...
ShipJob.Talk.next.push Page.ShipTalkVoyeur = class ShipTalkVoyeur extends Page
  conditions:
    ...
    # I suppose this could be any officer, though if Nat, the Report option will need to be replaced with something else.
...
ShipJob.Talk.next.push Page.ShipTalkVoyeur.next.Watch = Page.ShipTalkVoyeurWatch = class ShipTalkVoyeurWatch extends Page
    text: ->"""||
...
ShipJob.Talk.next.push Page.ShipTalkVoyeur.next.Join = Page.ShipTalkVoyeurJoin = class ShipTalkVoyeurJoin extends Page
    text: ->"""||
    #   if exists "Ship.holdNight" then bg="Ship.holdNight"
    #   else bg="Ship.deckNight"
    --
...
ShipJob.Talk.next.push Page.ShipTalkVoyeur.next.Ignore = Page.ShipTalkVoyeurIgnore = class ShipTalkVoyeurIgnore extends Page
    text: ->"""||
    #   if exists "Ship.holdNight" then bg="Ship.holdNight"
    #   else bg="Ship.deckNight"
    --
...
ShipJob.Talk.next.push Page.ShipTalkVoyeur.next.Report = Page.ShipTalkVoyeurReport = class ShipTalkVoyeurReport extends Page
    text: ->"""||
    #   if exists "Ship.holdNight" then bg="Ship.holdNight"
    #   else bg="Ship.deckNight"
    --
